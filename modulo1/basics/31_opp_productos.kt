...
fun main() {
    ...
    CatalogoProductos.agregarProducto("Disco duro externo 2t", 150.99, 10, 1)
    CatalogoProductos.agregarProducto("Teclado inaámbrico luces Led", 35.99, 5, 1)
    ...
    for (producto in CatalogoProductos.listar()){
        println("${producto.nombre} ${producto.stock} ${producto.precio}")
    }
}
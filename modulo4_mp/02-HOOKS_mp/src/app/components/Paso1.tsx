...
export default function Paso1() {
  ...
  const estadoTexto = conectado
    ? '✓ Conectado al sistema de inventario'
  ...
  return (
    <View style={styles.contenedor}>
      <Text style={styles.titulo}>Conexión al Sistema de Inventario</Text>

      <View style={[styles.tarjeta, { borderColor: colorEstado }]}>
        <Text style={[styles.estado, { color: colorEstado }]}>
          {estadoTexto}
        </Text>
        <Text style={styles.detalle}>Servidor inventario · 192.168.1.100</Text>
      </View>

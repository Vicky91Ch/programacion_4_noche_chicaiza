            ...
            FilledButton.icon(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Registrando ${_ctrlMarca.text} ${_ctrlModelo.text}'),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: FormularioVenta(
          onGuardar: (datos) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Venta: ${datos['marca']} ${datos['modelo']}')),
            );
          },
        ),
      ),
    ...
    return Scaffold(
      ...
      body: _ventas.isEmpty
          ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              const SizedBox(height: 12),
              Text('Sin ventas', style: TextStyle(color: cs.onSurfaceVariant)),
            ]))
          : ListView.separated(
